...
namespace TNovationProject
{
    public partial class ListEvent : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'tNovationDataSetLATESTAPRIL.tblEvent' table. You can move, or remove it, as needed.
            this.tblEventTableAdapter1.Fill(this.tNovationDataSetLATESTAPRIL.tblEvent);
